...
const photographyCategories = ['photography-videography'];
...
export default function PhotographySettingsPage() {
  ...
  const organizationLabel = form.organizationName || user?.organizationName || user?.name || 'Photography Vendor';
    ...
    const loadProfile = async () => {
      try {
        ...
        setForm({
          ...
          categories: data.categories?.length ? data.categories : photographyCategories,
        });
      } catch (error) {
