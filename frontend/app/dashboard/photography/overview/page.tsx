...
export default function PhotographyOverviewPage() {
      ...
      <aside className="w-full md:w-64 bg-white shadow-lg flex flex-col">
        ...
        <nav className="flex-1 p-4">
          <div className="mb-6">
            ...
            <button onClick={() => router.push('/dashboard/photography/overview')} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-1 transition-colors" style={{ backgroundColor: '#755A7B', color: 'white' }}>
              <FaChartBar /> Overview
            </button>
          ...
          <div>
            ...
            <button onClick={() => router.push('/dashboard/photography/feedback')} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-1 text-gray-600 hover:bg-gray-100"><FaComments /> Feedback</button>
      ...
      <div className="flex-1 flex flex-col">
        <main className="flex-1 overflow-y-auto p-4 md:p-8">
          ...
          <div className="mb-6 md:mb-8 rounded-lg overflow-hidden shadow-lg" style={{ backgroundImage: 'url(/photography.png)', backgroundSize: 'cover', backgroundPosition: 'center', height: '180px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', border: '2px solid rgba(117, 90, 123, 0.2)' }}>
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-2" style={{ textShadow: '3px 3px 6px rgba(0,0,0,0.7)' }}>Photography Overview</h2>
                ...
                <div className="xl:col-span-2 space-y-6">
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button onClick={() => router.push('/dashboard/photography/posted-packages')} className="rounded-lg px-4 py-2 text-white font-medium" style={{ backgroundColor: '#755A7B' }}>
                        Open Packages
                      </button>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex items-center justify-between rounded-lg px-4 py-3" style={{ backgroundColor: 'rgba(117, 90, 123, 0.05)' }}>
                        <span className="text-gray-700">Total photography value</span>
