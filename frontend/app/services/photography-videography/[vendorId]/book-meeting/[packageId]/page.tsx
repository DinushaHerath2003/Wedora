...
export default function PhotographyBookMeetingPage() {
  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        console.error('Failed to load photography booking data', error);
  ...
  const handleRequestBooking = async () => {
    ...
    try {
      ...
      setBookingNote('');
      setToast({ message: 'Booking request sent. The photographer will review and approve it.', type: 'success' });
    } catch (error) {
      console.error('Failed to create photography booking request', error);
      setToast({
        ...
        <div className="lg:col-span-2 space-y-6">
          <section className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="relative h-72 md:h-96 bg-gray-100 overflow-hidden">
              <img src={packageData.images?.[0] || '/photography.png'} alt={packageData.name} className="w-full h-full object-cover" />
        ...
        <aside className="space-y-6">
          <section className="bg-white rounded-xl shadow-md p-6 sticky top-24">
            ...
            <div className="mb-6">
              ...
              <textarea value={bookingNote} onChange={(e) => setBookingNote(e.target.value)} rows={4} className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white text-gray-900 placeholder-gray-400" placeholder="Tell the photographer what you'd like to discuss..." />
            </div>
